// to check is js enabled or not on browser just send a ajax request with some mode query and if that true serve static files else
// use res.render for hbs file this way we can handle SSR and CSR together
